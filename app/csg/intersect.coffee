...
# Core intersect algorithm for polytree-to-polytree operations
intersectCore = (polytreeA, polytreeB, buildTargetPolytree = true) ->
...
Polytree.intersect = (mesh1, mesh2, targetMaterial = null) ->
    ...
    if mesh1.isPolytree and mesh2.isPolytree
        ...
        return intersectCore(polytreeA, polytreeB, buildTargetPolytree)
        ...
        resultPolytree = intersectCore(polytreeA, polytreeB, false)
...
Polytree.intersectCore = intersectCore
